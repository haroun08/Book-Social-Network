...
export class BookService extends BaseService {
   ...
   *
   * This method sends `multiplart/form-data` and handles request body of type `multiplart/form-data`.
   */
  ...
  static readonly ApproveReturnBorrowBookPath = '/books/borrow/approved/{book-id}';
